...
public class CriteriaTriggers {
   ...
   public static final ItemInteractWithBlockTrigger ALLAY_DROP_ITEM_ON_BLOCK = register(new ItemInteractWithBlockTrigger(new ResourceLocation("allay_drop_item_on_block")));

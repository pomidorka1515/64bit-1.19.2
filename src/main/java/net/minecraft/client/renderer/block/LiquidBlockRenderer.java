   ...
   public void tesselate(BlockAndTintGetter p_234370_, BlockPos p_234371_, VertexConsumer p_234372_, BlockState p_234373_, FluidState p_234374_) {
      ...
      if (flag1 || flag2 || flag6 || flag5 || flag3 || flag4) {
         ...
         if (flag1 && !isFaceOccludedByNeighbor(p_234370_, p_234371_, Direction.UP, Math.min(Math.min(f8, f10), Math.min(f9, f7)), blockstate1)) {
            ...
            float f31 = f4 * f1;
            float f32 = f4 * f2;
            this.vertex(p_234372_, d1 + 0.0D, d2 + (double)f8, d0 + 0.0D, f30, f31, f32, f18, f22, j);
            this.vertex(p_234372_, d1 + 0.0D, d2 + (double)f10, d0 + 1.0D, f30, f31, f32, f19, f23, j);
            this.vertex(p_234372_, d1 + 1.0D, d2 + (double)f9, d0 + 1.0D, f30, f31, f32, f20, f24, j);
            this.vertex(p_234372_, d1 + 1.0D, d2 + (double)f7, d0 + 0.0D, f30, f31, f32, f21, f25, j);
         ...
         if (flag2) {
            ...
            float f47 = f3 * f1;
            float f48 = f3 * f2;
            this.vertex(p_234372_, d1, d2 + (double)f17, d0 + 1.0D, f46, f47, f48, f40, f43, l);
            this.vertex(p_234372_, d1, d2 + (double)f17, d0, f46, f47, f48, f40, f42, l);
            this.vertex(p_234372_, d1 + 1.0D, d2 + (double)f17, d0, f46, f47, f48, f41, f42, l);
            this.vertex(p_234372_, d1 + 1.0D, d2 + (double)f17, d0 + 1.0D, f46, f47, f48, f41, f43, l);
         }
         ...
         for(Direction direction : Direction.Plane.HORIZONTAL) {
            ...
            if (flag7 && !isFaceOccludedByNeighbor(p_234370_, p_234371_, direction, Math.max(f44, f45), p_234370_.getBlockState(p_234371_.relative(direction)))) {
               ...
               float f38 = f4 * f36 * f1;
               float f39 = f4 * f36 * f2;
               this.vertex(p_234372_, d3, d2 + (double)f44, d4, f37, f38, f39, f54, f33, k);
               this.vertex(p_234372_, d5, d2 + (double)f45, d6, f37, f38, f39, f55, f34, k);
               this.vertex(p_234372_, d5, d2 + (double)f17, d6, f37, f38, f39, f55, f35, k);
               this.vertex(p_234372_, d3, d2 + (double)f17, d4, f37, f38, f39, f54, f35, k);

...
public class ModelBlockRenderer {
   ...
   static class Cache {
      ...
      private final Object2IntLinkedOpenHashMap<BlockPos> colorCache = Util.make(() -> {
         Object2IntLinkedOpenHashMap<BlockPos> long2intlinkedopenhashmap = new Object2IntLinkedOpenHashMap<>(100, 0.25F) {
            /**
			 * 
			 */
      ...
      private final Object2FloatLinkedOpenHashMap<BlockPos> brightnessCache = Util.make(() -> {
         Object2FloatLinkedOpenHashMap<BlockPos> long2floatlinkedopenhashmap = new Object2FloatLinkedOpenHashMap<>(100, 0.25F) {
			private static final long serialVersionUID = 8964L;
      ...
      public float getShadeBrightness(BlockState p_111227_, BlockAndTintGetter p_111228_, BlockPos p_111229_) {
         if (this.enabled) {
            float f = this.brightnessCache.get(p_111229_);
            if (!Float.isNaN(f)) {
               return f;
            }
         }

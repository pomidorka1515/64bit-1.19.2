      ...
      if (blockstate.getRenderShape() != RenderShape.INVISIBLE && p_114434_.getMaxLocalRawBrightness(p_114435_) > 3) {
         if (blockstate.isCollisionShapeFullBlock(p_114434_, blockpos)) {
            ...
            if (!voxelshape.isEmpty()) {
               float f = LightTexture.getBrightness(p_114434_.dimensionType(), p_114434_.getMaxLocalRawBrightness(p_114435_));
               ...
               if (f1 >= 0.0F) {
                  ...
                  float f5 = (float)(d3 - p_114438_);
                  float f6 = (float)(d4 - p_114438_);
                  float f7 = -f2 / 2.0F / p_114439_ + 0.5F;
                  float f8 = -f3 / 2.0F / p_114439_ + 0.5F;
                  float f9 = -f5 / 2.0F / p_114439_ + 0.5F;
                  float f10 = -f6 / 2.0F / p_114439_ + 0.5F;
                  shadowVertex(p_114432_, p_114433_, f1, f2, f4, f5, f7, f9);
                  shadowVertex(p_114432_, p_114433_, f1, f2, f4, f6, f7, f10);
                  shadowVertex(p_114432_, p_114433_, f1, f3, f4, f6, f8, f10);
                  shadowVertex(p_114432_, p_114433_, f1, f3, f4, f5, f8, f9);
               }

...
public class EntityRenderers {
   ...
   public static Map<EntityType<?>, EntityRenderer<?>> createEntityRenderers(EntityRendererProvider.Context p_174050_) {
      ...
      PROVIDERS.forEach((p_234602_, p_234603_) -> {
         try {
            builder.put(p_234602_, p_234603_.create(p_174050_));
         } catch (Exception exception) {
            throw new IllegalArgumentException("Failed to create model for " + Registry.ENTITY_TYPE.getKey(p_234602_), exception);
         }
      });

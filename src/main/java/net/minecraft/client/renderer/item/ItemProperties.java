...
public class ItemProperties {
   ...
   static {
      ...
      register(Items.CROSSBOW, new ResourceLocation("charged"), (p_174600_, p_174601_, p_174602_, p_174603_) -> {
         return p_174602_ != null && CrossbowItem.isCharged(p_174600_) ? 1.0F : 0.0F;
      });
      register(Items.CROSSBOW, new ResourceLocation("firework"), (p_174595_, p_174596_, p_174597_, p_174598_) -> {

...
public enum Direction implements StringRepresentable {
   ...
   private static final Object2ObjectMap<BlockPos, Direction> BY_NORMAL = Arrays.stream(VALUES).collect(Collectors.toMap((p_235679_) -> {
      return (new BlockPos(p_235679_.getNormal()));
   }, (p_235675_) -> {
      return p_235675_;
   }, (p_235670_, p_235671_) -> {
   ...
   public static Direction fromNormal(BlockPos p_175361_) {
      return BY_NORMAL.get(p_175361_);
   }

   @Nullable
   public static Direction fromNormal(int p_122379_, int p_122380_, int p_122381_) {
      return BY_NORMAL.get(new BlockPos(p_122379_, p_122380_, p_122381_));
   }
   ...
   public static enum Axis implements StringRepresentable, Predicate<Direction> {
      X("x") {
         public long choose(long p_122496_, int p_122497_, long p_122498_) {
            return p_122496_;
         }
      ...
      Y("y") {
         public long choose(long p_122510_, int p_122511_, long p_122512_) {
            return p_122511_;
         }
      ...
      Z("z") {
         public long choose(long p_122524_, int p_122525_, long p_122526_) {
            return p_122526_;
         }
      ...
      public abstract long choose(long p_122466_, int p_122467_, long p_122468_);

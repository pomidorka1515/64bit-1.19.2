...
public abstract class Registry<T> implements Keyable, IdMap<T> {
   ...
   public static final DefaultedRegistry<ChunkStatus> CHUNK_STATUS = registerDefaulted(CHUNK_STATUS_REGISTRY, "empty", (p_235775_) -> {
   ...
   public static final Registry<MenuType<?>> MENU = registerSimple(MENU_REGISTRY, (p_235769_) -> {
      return MenuType.ANVIL;
   });
   public static final Registry<RecipeType<?>> RECIPE_TYPE = registerSimple(RECIPE_TYPE_REGISTRY, (p_235767_) -> {
      return RecipeType.CRAFTING;
   });
   public static final Registry<RecipeSerializer<?>> RECIPE_SERIALIZER = registerSimple(RECIPE_SERIALIZER_REGISTRY, (p_235765_) -> {
      return RecipeSerializer.SHAPELESS_RECIPE;
   });
   public static final Registry<Attribute> ATTRIBUTE = registerSimple(ATTRIBUTE_REGISTRY, (p_235763_) -> {
   ...
   public static final Registry<ArgumentTypeInfo<?, ?>> COMMAND_ARGUMENT_TYPE = registerSimple(COMMAND_ARGUMENT_TYPE_REGISTRY, (RegistryBootstrap)ArgumentTypeInfos::bootstrap);
   public static final Registry<StatType<?>> STAT_TYPE = registerSimple(STAT_TYPE_REGISTRY, (p_235759_) -> {
   ...
   public static final DefaultedRegistry<VillagerProfession> VILLAGER_PROFESSION = registerDefaulted(VILLAGER_PROFESSION_REGISTRY, "none", (p_235755_) -> {
   ...
   public static final DefaultedRegistry<MemoryModuleType<?>> MEMORY_MODULE_TYPE = registerDefaulted(MEMORY_MODULE_TYPE_REGISTRY, "dummy", (p_235753_) -> {
      return MemoryModuleType.DUMMY;
   });
   public static final DefaultedRegistry<SensorType<?>> SENSOR_TYPE = registerDefaulted(SENSOR_TYPE_REGISTRY, "dummy", (p_235751_) -> {
      return SensorType.DUMMY;
   });
   public static final Registry<Schedule> SCHEDULE = registerSimple(SCHEDULE_REGISTRY, (p_235749_) -> {
      return Schedule.EMPTY;
   });
   public static final Registry<Activity> ACTIVITY = registerSimple(ACTIVITY_REGISTRY, (p_235747_) -> {
   ...
   public static final Registry<WorldCarver<?>> CARVER = registerSimple(CARVER_REGISTRY, (p_235842_) -> {
   ...
   public static final Registry<Feature<?>> FEATURE = registerSimple(FEATURE_REGISTRY, (p_235840_) -> {
      return Feature.ORE;
   });
   ...
   public static final Registry<BlockStateProviderType<?>> BLOCKSTATE_PROVIDER_TYPES = registerSimple(BLOCK_STATE_PROVIDER_TYPE_REGISTRY, (p_235830_) -> {
      return BlockStateProviderType.SIMPLE_STATE_PROVIDER;
   });
   public static final Registry<FoliagePlacerType<?>> FOLIAGE_PLACER_TYPES = registerSimple(FOLIAGE_PLACER_TYPE_REGISTRY, (p_235828_) -> {
   ...
   public static final Registry<TreeDecoratorType<?>> TREE_DECORATOR_TYPES = registerSimple(TREE_DECORATOR_TYPE_REGISTRY, (p_235814_) -> {
   ...
   public static <T extends Registry<?>> void checkRegistry(Registry<T> p_205993_) {
      p_205993_.forEach((p_235790_) -> {
         if (p_235790_.keySet().isEmpty()) {
            Util.logAndPauseIfInIde("Registry '" + p_205993_.getKey(p_235790_) + "' was empty after loading");
         }

         if (p_235790_ instanceof DefaultedRegistry) {
            ResourceLocation resourcelocation = ((DefaultedRegistry)p_235790_).getDefaultKey();
            Validate.notNull(p_235790_.get(resourcelocation), "Missing default of DefaultedMappedRegistry: " + resourcelocation);
         }
   ...
   public abstract Optional<Holder<T>> getRandom(RandomSource p_235781_);
   ...
   public abstract Holder<T> getOrCreateHolderOrThrow(ResourceKey<T> p_235795_);

   public abstract DataResult<Holder<T>> getOrCreateHolder(ResourceKey<T> p_235798_);

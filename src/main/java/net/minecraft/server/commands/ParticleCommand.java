...
public class ParticleCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> p_138123_) {
      p_138123_.register(Commands.literal("particle").requires((p_138127_) -> {
         ...
         return sendParticles(p_138148_.getSource(), ParticleArgument.getParticle(p_138148_, "name"), p_138148_.getSource().getExactPosition().toApproximateVec3(), Vec3.ZERO, 0.0F, 0, false, p_138148_.getSource().getServer().getPlayerList().getPlayers());
      }).then(Commands.argument("pos", Vec3Argument.vec3()).executes((p_138146_) -> {
         return sendParticles(p_138146_.getSource(), ParticleArgument.getParticle(p_138146_, "name"), Vec3Argument.getCoordinates(p_138146_, "pos").getPosition(p_138146_.getSource()), Vec3.ZERO, 0.0F, 0, false, p_138146_.getSource().getServer().getPlayerList().getPlayers());
   ...
   private static int sendParticles(CommandSourceStack p_138129_, ParticleOptions p_138130_, Vec3 p_138131_, Vec3 p_138132_, float p_138133_, int p_138134_, boolean p_138135_, Collection<ServerPlayer> p_138136_) throws CommandSyntaxException {
      ...
      if (i == 0) {
         ...
         p_138129_.sendSuccess(Component.translatable("commands.particle.success", Registry.PARTICLE_TYPE.getKey(p_138130_.getType()).toString()), true);
         return i;
      }
   }
}
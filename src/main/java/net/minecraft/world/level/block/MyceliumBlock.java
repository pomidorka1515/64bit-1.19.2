...
public class MyceliumBlock extends SpreadingSnowyDirtBlock {
   ...
   public void animateTick(BlockState p_221789_, Level p_221790_, BlockPos p_221791_, RandomSource p_221792_) {
      ...
      if (p_221792_.nextInt(10) == 0) {
         p_221790_.addParticle(ParticleTypes.MYCELIUM, SectorVec3.fromBlockAndFraction(p_221791_.getX(),
               p_221792_.nextDouble(), (double)p_221791_.getY() + 1.1D, p_221791_.getZ(),
               p_221792_.nextDouble()), 0.0D, 0.0D, 0.0D);
      }

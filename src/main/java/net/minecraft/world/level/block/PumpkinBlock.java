   ...
   public InteractionResult use(BlockState p_55289_, Level p_55290_, BlockPos p_55291_, Player p_55292_, InteractionHand p_55293_, BlockHitResult p_55294_) {
      ...
      if (itemstack.is(Items.SHEARS)) {
         if (!p_55290_.isClientSide) {
            ...
            ItemEntity itementity = new ItemEntity(p_55290_, net.minecraft.world.phys.SectorVec3.fromBlockAndFraction(
                  p_55291_.getX(), 0.5D + (double)direction1.getStepX() * 0.65D, (double)p_55291_.getY() + 0.1D,
                  p_55291_.getZ(), 0.5D + (double)direction1.getStepZ() * 0.65D), new ItemStack(Items.PUMPKIN_SEEDS, 4));

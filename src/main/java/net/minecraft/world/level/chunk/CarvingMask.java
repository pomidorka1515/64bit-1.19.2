...
public class CarvingMask {
   ...
   private int getIndex(long p_187599_, int p_187600_, long p_187601_) {
      return (int) (p_187599_ & 15 | (p_187601_ & 15) << 4 | p_187600_ - this.minY << 8);
   }

   public void set(long p_187586_, int p_187587_, long p_187588_) {

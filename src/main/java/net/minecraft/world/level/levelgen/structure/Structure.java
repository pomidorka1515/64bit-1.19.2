...
public abstract class Structure {
   ...
   public StructureStart generate(RegistryAccess p_226597_, ChunkGenerator p_226598_, BiomeSource p_226599_, RandomState p_226600_, StructureTemplateManager p_226601_, long p_226602_, ChunkPos p_226603_, int p_226604_, LevelHeightAccessor p_226605_, Predicate<Holder<Biome>> p_226606_) {
      Optional<Structure.GenerationStub> optional = this.findGenerationPoint(new Structure.GenerationContext(p_226597_, p_226598_, p_226599_, p_226600_, p_226601_, p_226602_, p_226603_, p_226605_, p_226606_));
      if (optional.isPresent() && isValidBiome(optional.get(), p_226598_, p_226600_, p_226606_)) {
   ...
   private static boolean isValidBiome(Structure.GenerationStub p_226590_, ChunkGenerator p_226591_, RandomState p_226592_, Predicate<Holder<Biome>> p_226593_) {
      BlockPos blockpos = p_226590_.position();
      return p_226593_.test(p_226591_.getBiomeSource().getNoiseBiome(QuartPos.fromBlock(blockpos.getX()), QuartPos.fromBlock(blockpos.getY()), QuartPos.fromBlock(blockpos.getZ()), p_226592_.sampler()));
   }
   ...
   private static int[] getCornerHeights(Structure.GenerationContext p_226614_, long p_226615_, int p_226616_, long p_226617_, int p_226618_) {
   ...
   protected static int getLowestY(Structure.GenerationContext p_226577_, long p_226578_, long p_226579_, int p_226580_, int p_226581_) {
   ...
   public abstract Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext p_226571_);

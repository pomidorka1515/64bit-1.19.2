...
public final class StructureStart {
   ...
   public static StructureStart loadStaticStart(StructurePieceSerializationContext p_226858_, CompoundTag p_226859_, long p_226860_) {
      ...
      if ("INVALID".equals(s)) {
         ...
         Registry<Structure> registry = p_226858_.registryAccess().registryOrThrow(Registry.STRUCTURE_REGISTRY);
   ...
   public CompoundTag createTag(StructurePieceSerializationContext p_192661_, ChunkPos p_192662_) {
      ...
      if (this.isValid()) {
         compoundtag.putString("id", p_192661_.registryAccess().registryOrThrow(Registry.STRUCTURE_REGISTRY).getKey(this.structure).toString());
